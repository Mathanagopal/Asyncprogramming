...
container.innerHTML = `
<h1 id="title" class="text-center">Rest Countires and Weather using Fetch API</h1><br/><br/>
...
async function buttonClick(lat, long, weatherTextId, btnID) {
    try {
        ...
        document.getElementById(weatherTextId).innerHTML = `
        <p class="weather"><b>Weather:</b> ${weatherData.weather[0].main} <br><b>Temp:</b> ${weatherData.main.temp} <i><img id="wicon" src="${iconURL}" alt="Weather icon"></i> 
